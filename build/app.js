...
/***/ function(module, exports, __webpack_require__) {
	...
	var abacus = {
	  ...
	  department: [[5.52, 1.16, 37.73], [7.44, 1.76, 36.78], [5.80, 0.95, 28.30], [7.71, 1.30, 23.04], [4.17, 0.93, 32.59], [6.98, 1.19, 39.75], [5.96, 1.15, 37.29], [4.25, 0.81, 28.06], [5.19, 0.91, 40.62]],
	  // meetings/week, avg meeting duration, %unproductive
	  sector: [[8.75, 1.72, 48.75], [8.14, 0.90, 67.29], [6.95, 1.15, 29.54], [6.52, 1.12, 28.00], [6.33, 1.20, 34.34], [6.09, 1.01, 37.50], [5.57, 1.03, 50.07], [5.35, 1.11, 31.61], [5.18, 1.03, 30.35], [5.05, 0.73, 47.24], [5.00, 1.01, 28.81], [4.96, 0.96, 34.51], [4.93, 1.36, 31.67], [4.40, 1.30, 32.93], [3.44, 0.98, 52.28]]
	};
	...
	var CalculatorBox = React.createClass({
	  ...
	  onChangeHandle: function (change) {
	    ...
	    var team = abacus.department[inputs.department][0] * abacus.sector[inputs.sector][1] * abacus.department[inputs.department][2] / 100 * 48 * inputs.team;
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'Result' },
	        React.createElement(Result, { team: this.state.team, company: this.state.company })
	      )
	    );
	  }
	});
	...
	var CompanySector = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'select',
	        { ref: 'select', type: 'select', onChange: this.onChange, name: 'CompanySector', id: 'CompanySector' },
	        React.createElement(
	          'option',
	          { value: '' },
	          'Please choose..'
	...
	var CompanySize = React.createClass({
	  ...
	  getInitialState: function () {
	    return {
	      sizes: [{ count: 1, label: 'Self employed' }, { count: 7, label: '1 - 9 employees' }, { count: 42, label: '10 - 49 employees' }, { count: 82, label: '50 - 99 employees' }, { count: 198, label: '100 - 249 employees' }, { count: 451, label: '250 - 500 employees' }, { count: 1337, label: 'More than 500' }]
	    };
	  },
	  onChange: function (e) {
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'select',
	        { ref: 'select', type: 'select', onChange: this.onChange, name: 'CompanySize', id: 'CompanySize' },
	        React.createElement(
	          'option',
	          { value: '' },
	          'Please choose..'
	...
	var CompanyDepartment = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'select',
	        { ref: 'select', type: 'select', onChange: this.onChange, name: 'CompanyDepartment', id: 'CompanyDepartment' },
	        React.createElement(
	          'option',
	          { value: '' },
	          'Please choose..'
	...
	var TeamMembers = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement('input', { ref: 'input', type: 'number', onChange: this.onChange, name: 'TeamMembers', id: 'TeamMembers' })
	    );
	  }
	});
	...
	var Result = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      { className: 'Result' },
	      !this.props.team && !this.props.company && !this.props.department && !this.props.team ? React.createElement(
	        'div',
	        null,
	        'Plase select..'
	      ) : React.createElement(
