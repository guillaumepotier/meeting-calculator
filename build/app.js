...
/***/ function(module, exports, __webpack_require__) {
	...
	window.locales = __webpack_require__(167);
	window.lang = 'en';
	
	if ('#fr' === window.location.hash) window.lang = 'fr';
	
	window.abacus = __webpack_require__(168)[window.lang];
	
	var sharing = __webpack_require__(169);
	var components = __webpack_require__(170);
	...
	window.i18n = window.__ = function (string) {
	  if (!window.locales[window.lang]) return string;
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                __('How much could you spare by putting an end to unproductive meetings?')
	              )
	            )
	          )
	        ),
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'h4',
	                null,
	                __('Waste in unproductive meetings per year')
	              ),
	              React.createElement(
	                'div',
	                ...
	                React.createElement('div', { className: 'Grid-cell Grid-cell--3 Grid-cell--money', dangerouslySetInnerHTML: { __html: __('&pound; %f').replace('%f', this.state.team.money) } })
	              ),
	              React.createElement(
	                'div',
	                { className: 'Grid Grid--results' },
	                ...
	                React.createElement('div', { className: 'Grid-cell Grid-cell--3 Grid-cell--money', dangerouslySetInnerHTML: { __html: __('&pound; %f').replace('%f', this.state.company.money) } })
	              )
	            )
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'p',
	              null,
	              __('Want to discuss? Wisembly has the expertise to help you run engaging and productive meetings every time.')
	            )
	          ),
	          React.createElement(
	            'div',
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'a',
	                { href: __('http://wisembly.com/en/blog/2016/05/19/uk-survey-wisembly-censuswide-meeting-cost-2016'), target: '_blank' },
	...
	ReactDOM.render(React.createElement(CalculatorBox, null), document.getElementById('content'));
...
/***/ function(module, exports) {
	...
	module.exports = {
	  fr: {
	    ...
	    "mailto:contact@wisembly.com?subject=Let's start running productive meetings&body=I would like to be contacted by an expert from the Wisembly Team.%0D%0A Here is my phone number:%0D%0A Cheers": "mailto:contact@wisembly.com?subject=Construisons des réunions plus productives&body=Je souhaiterais être contacté par un expert de l\'équipe Wisembly%0D%0AMon numéro de téléphone:%0D%0ACordialement",
	    ...
	    'http://wisembly.com/en/blog/2016/05/19/uk-survey-wisembly-censuswide-meeting-cost-2016': 'http://wisembly.com/blog/2016/03/30/la-reunion-de-demain-sera-productive-quels-formats-privilegier-resultats-du-barometre-annuel-de-wisembly-en-partenariat-avec-lifop',
...
/***/ function(module, exports) {
	...
	module.exports = {
	  en: {
	    ...
	    sector: [[8.75, 1.72, 48.75, 46, 19.56], // Publishers
	    ...
	    // meetings/week, avg meeting duration, %unproductive
	    size: [[3.90, 0.95, 29], // 1 - 9 employees
	  ...
	  fr: {
	    ...
	    // meetings/week, avg meeting duration, %unproductive, % white collars, mean salary
	    sector: [[2.6, 1.70, 42.8, 33.5, 24.19], // Industrie agroalimentaire
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TwitterButton = React.createClass({
	  ...
	  renderWidget: function renderWidget(nextProps) {
	...
	var CompanySize = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { ref: 'input', type: 'text', pattern: '[0-9]*', onChange: this.onChange, placeholder: __('Number of employees'), name: 'CompanySize', id: 'CompanySize', className: 'Input' })
	    );
	  }
	});
